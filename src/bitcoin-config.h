...
#define PACKAGE_BUGREPORT "info@vaperscoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vaperscoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vaperscoin Core 1.8.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vaperscoin"
