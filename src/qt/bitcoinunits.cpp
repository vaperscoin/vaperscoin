...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MVPRC);
    unitlist.append(kVPRC);
    unitlist.append(VPRC);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MVPRC: return QString("MVPRC");
    case kVPRC: return QString("kVPRC");
    case VPRC: return QString("VPRC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MVPRC: return QString("Mega-Vaperscoin (1,000,000 VPRC)");
    case kVPRC: return QString("Kilo-Vaperscoin (1000 VPRC)");
    case VPRC: return QString("Vaperscoin");
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MVPRC: return 6;  // 900,000 (# digits, without commas)
    case kVPRC: return 9;  // 900,000,000
    case VPRC:  return 12; // 900,000,000,000
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MVPRC: return 14;
    case kVPRC: return 11;
    case VPRC: return 8;
    case Koinu: return 0;
    default: return 0;
    }
