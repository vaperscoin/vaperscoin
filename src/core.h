...
static const int64_t MAX_MONEY = 42750000000ULL * COIN; // Vaperscoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000
...
public:
    ...
    {
        // Vaperscoin: IsDust() detection disabled, allows any valid dust to be relayed.
