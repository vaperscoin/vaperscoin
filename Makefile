...
pkgdatadir = $(datadir)/vaperscoin
pkgincludedir = $(includedir)/vaperscoin
pkglibdir = $(libdir)/vaperscoin
pkglibexecdir = $(libexecdir)/vaperscoin
...
am__aclocal_m4_deps = $(top_srcdir)/src/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/src/m4/vaperscoin_find_bdb53.m4 \
...
ACLOCAL = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/missing automake-1.15
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
...
COPYRIGHT_YEAR = 2014
CPP = gcc -E
CPPFLAGS =  -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -I/include -DMAC_OSX  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2
CRYPTO_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2h_1/include
CRYPTO_LIBS = -L/usr/local/Cellar/openssl/1.0.2h_1/lib -lcrypto
CXX = g++
CXXCPP = g++ -E
...
INCLUDES =  -D_THREAD_SAFE -pthread -I/usr/local/Cellar/openssl/1.0.2h_1/include -I/usr/local/Cellar/openssl/1.0.2h_1/include
...
LIBMEMENV = 
LIBOBJS = 
LIBS =  -L/lib -L/usr/local/Cellar/openssl/1.0.2h_1/lib -lssl -L/usr/local/Cellar/openssl/1.0.2h_1/lib -lcrypto
LN_S = ln -s
LRELEASE = /usr/local/bin/lrelease
LTLIBOBJS = 
LUPDATE = /usr/local/bin/lupdate
MAINT = 
MAKEINFO = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/missing makeinfo
MAKENSIS = 
...
OTOOL = 
PACKAGE = vaperscoin
PACKAGE_BUGREPORT = info@vaperscoin.com
PACKAGE_NAME = Vaperscoin Core
PACKAGE_STRING = Vaperscoin Core 1.8.2
PACKAGE_TARNAME = vaperscoin
PACKAGE_URL = 
...
PORT = 
PROTOBUF_CFLAGS = -D_THREAD_SAFE -I/usr/local/Cellar/protobuf/2.6.1/include
PROTOBUF_LIBS = -L/usr/local/Cellar/protobuf/2.6.1/lib -lprotobuf -D_THREAD_SAFE
PROTOC = /usr/local/bin/protoc
PTHREAD_CC = gcc
PTHREAD_CFLAGS = -D_THREAD_SAFE -pthread
PTHREAD_LIBS = 
QR_CFLAGS = -I/usr/local/Cellar/qrencode/3.4.4/include
QR_LIBS = -L/usr/local/Cellar/qrencode/3.4.4/lib -lqrencode
QT_CFLAGS = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtGui -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtNetwork -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtCore
QT_DBUS_CFLAGS = 
QT_DBUS_INCLUDES = 
QT_DBUS_LIBS = 
QT_INCLUDES = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtGui -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtNetwork -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtCore
QT_LDFLAGS = 
QT_LIBS = -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtGui -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtNetwork -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtCore -framework Foundation -framework ApplicationServices -framework AppKit
QT_SELECT = qt4
QT_TEST_CFLAGS = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtTest
QT_TEST_INCLUDES = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.7_2/include -I/usr/local/Cellar/qt/4.8.7_2/include/QtTest
QT_TEST_LIBS = -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtTest
RANLIB = /usr/bin/ranlib
RCC = /usr/local/bin/rcc
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/sh
SSL_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2h_1/include
SSL_LIBS = -L/usr/local/Cellar/openssl/1.0.2h_1/lib -lssl
STRIP = /usr/bin/strip
TESTDEFS = 
...
WINDRES = 
XGETTEXT = 
abs_builddir = /Users/pm/github/vapourcoin
abs_srcdir = /Users/pm/github/vapourcoin
abs_top_builddir = /Users/pm/github/vapourcoin
abs_top_srcdir = /Users/pm/github/vapourcoin
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /Users/pm/github/vapourcoin/src/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/vaperscoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/vaperscoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/vaperscoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Vaperscoin-Qt.app
OSX_DMG = Vaperscoin-Qt.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Vaperscoin-Qt
...
$(OSX_APP)/Contents/MacOS/Vaperscoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "Vaperscoin-Qt" -no-pad -r -apple -o $@ dist
...
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_vaperscoin -o $@
