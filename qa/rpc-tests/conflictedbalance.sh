...
# Copyright (c) 2014 The Vaperscoin Core developers
...
BITCOIND=${1}/vaperscoind
CLI=${1}/vaperscoin-cli
...
# B1 should still be able to spend 1000000 (-1 VPRC fee for the successful transaction), because D is conflicted
