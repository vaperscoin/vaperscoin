# Vaperscoin Core 1.8.1

Vaperscoin Core 1.8.1 is primarily a bugfix release, bringing Vaperscoin Core in
line with Bitcoin 0.9.3. Vaperscoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by Vaperscoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Vaperscoin Core clients
* Use HTTPS with epcchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/vaperscoin/vaperscoin/issues/134).
